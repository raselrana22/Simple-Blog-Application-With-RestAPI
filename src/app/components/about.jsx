    ...
    <div className='container mx-auto p-4'>
      ...
      <div className='mb-8'>
        <p className='text-lg leading-relaxed'>
          ...
          interests and passions. Our team is dedicated to curating and creating
          content that informs, entertains, and sparks curiosity.
        </p>
      </div>
      <div className='mb-8'>
        ...
        <p className='text-lg leading-relaxed'>
          ...
          thought-provoking pieces. We believe in the power of knowledge and the
          joy of learning, and we aim to share that with our readers through our
      ...
      <div className='mb-8'>
        ...
        <ul className='list-disc list-inside text-lg leading-relaxed pl-4'>
          <li>
            In-Depth Exploration: From the latest trends in science to the rich
            history of civilizations, we delve deep into various topics to
            provide you with a comprehensive understanding.
          </li>
          <li>
            Diverse Perspectives: Our articles cover a wide range of categories,
            ensuring that every reader can find something that resonates with
            them.
          </li>
          <li>
            Engaging Content: We prioritize creating content that engages and
            captivates our readers. Whether it is a personal story, a scientific
            discovery, or a timeless fable, our articles aim to keep you hooked.
          </li>
          <li>
            Quality Writing: We take pride in our writing quality. Each article
            is carefully crafted to provide clarity, accuracy, and a pleasant
            reading experience.
          </li>
        </ul>
      </div>
      {/* <div className='mb-8'>
        ...
        <ul className='list-disc list-inside text-lg leading-relaxed pl-4'>
          <li>
            Library: Immerse yourself in the world of literature, book reviews,
            and literary discussions.
          </li>
          <li>
            History: Explore the annals of history and discover intriguing tales
            from different eras.
          </li>
          <li>
